...
import { AroConLonaImgData } from "../database";

const AroLonaImgFun = ({ className, title, subTitle }) => {
  return (
    <LightGallery
      speed={500}
    ...
    >
      {AroConLonaImgData.length > 0 &&
        AroConLonaImgData.map((item, i) => (
          <a
            key={i}
